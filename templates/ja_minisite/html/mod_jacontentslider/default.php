  ...
  <div class="ja-contentslider-center-wrap clearfix">
	...
	?>
	  ...
	  <?php } */?>
        ...
        <div class="ja_slideintro"> <?php echo ( $params->get('numchar') ) ? $contn->introtext1 : $contn->introtext; ?> 
         <?php if( $params->get('showreadmore') ){ ?>
        <span class="ja-slidereadmore"> <a href="<?php echo $link;?>" class="readon"><?php echo JTEXT::_('READ_MORE');?></a> </span>
        <?php } // endif;?></div>
        <?php } ?>
